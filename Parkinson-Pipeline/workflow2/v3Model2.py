...
OUTPUT_DIR = "model_validation_trustworthy"
...
plt.title(f'Confusion Matrix ({MODEL_TYPE} - trustworthy)')
plt.tight_layout()
...
disp.plot()
plt.title(f'ROC Curve ({MODEL_TYPE} - trustworthy)')
...
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.title(f'Loss Curves ({MODEL_TYPE} – Trustworthy)')
plt.legend()
...
disp.plot()
plt.title(f'Precision-Recall Curve ({MODEL_TYPE} - trustworthy)')
